...
const salvarProduto = (e) => {
  ...
  const preencherTabela = () =>{
      ...
      for(const produto of produtos){
          ...
          <td>
          <img type="button" width="40" src=" ./img/trash.svg" onclick="removerProduto(${produto.id})" />
          <img type= "button" width="40" src=" ./img/relatorio.png" onclick="editarProduto(${produto.id})" />
          </td>
          </tr>
